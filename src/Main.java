...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO Получить отсортированный по фамилии список потенциально работоспособных людей с высшим образованием в выборке
        //  (т.е. людей с высшим образованием от 18 до 60 лет для женщин и до 65 лет для мужчин).
        List<Person> ableBodiedPeopleWithHigherEducation = persons.stream()
                .filter(person -> person.getAge() >= 18)
